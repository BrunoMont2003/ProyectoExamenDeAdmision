 ...
 * @author bruno
 */
public class DialogReporteVacantes extends javax.swing.JDialog {
    ...
    public DialogReporteVacantes() throws SQLException {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(233, 244, 218));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 520, 430));
        ...
        jLabel2.setText("BUSCAR VACANTES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogReporteVacantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DialogReporteVacantes dialog = new DialogReporteVacantes();
                    ...
                    Logger.getLogger(DialogReporteVacantes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
