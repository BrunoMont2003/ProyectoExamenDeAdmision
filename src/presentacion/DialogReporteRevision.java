 ...
 * @author bruno
 */
public class DialogReporteRevision extends javax.swing.JDialog {
    ...
    public DialogReporteRevision() throws SQLException {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            examendao.mostrarResultadoDeExamenOrden(modelo, idExamen);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogReporteRevision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DialogReporteRevision dialog = new DialogReporteRevision();
                    ...
                    Logger.getLogger(DialogReporteRevision.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
